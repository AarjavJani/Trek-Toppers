...
<!-- Cards -->
<h1 class="display-6 mt-3 ms-5">Monsoon Season Treks:</h1>
<div class="row row-cols-1 row-cols-md-4 g-3 mx-5">
  <?php
  // Assuming $conn is your MySQLi connection
  $sql = "SELECT t.TrekName, t.Location, t.Price, t.Season, h.Duration FROM Trek t JOIN highlights h ON t.Trek_ID = h.Trek_ID WHERE t.Season = 'Monsoon' ";
